...
% mainfolder = 'H:\Postdoc data\My_papers\Paper1_UKB issues\upload to Git\test'; %Input CRIC ECG data in .mat format
mainfolder = 'H:\Postdoc data\Databases\CRIC'; %Input CRIC ECG data in .mat format
...
for iFile = 1:numel(FileList);
    ...
    regname_all{iFile}=regname;
    ecg=FileData.ECG12Lead_bwr;
    ecg_fir=FileData.ECG12Lead_bwr';
    
   %load thresholds based .mat files (the ones computed from
   %"Threshold_computation_UKB_issues.m" file); %Note: not required if directly using UKB thresholds 
...
%lead reversal
    ...
    %following threshold are w.r.t. UKB thresholds, the one shown in Table
    %I, III, and V.
    ...
    if (max(abs(ecg(1:1000,1)))-min(abs(ecg(1:1000,1))))<40 || (max(abs(ecg(1001:2000,1)))-min(abs(ecg(1001:2000,1))))<40 || (max(abs(ecg(2001:3000,1)))-min(abs(ecg(2001:3000,1))))<40 || (max(abs(ecg(3001:4000,1)))-min(abs(ecg(3001:4000,1))))<40 || (max(abs(ecg(4001:end,1)))-min(abs(ecg(4001:end,1))))<40 ||...
       ...
       (max(abs(ecg(1:1000,7)))-min(abs(ecg(1:1000,7))))<1.7 || (max(abs(ecg(1001:2000,7)))-min(abs(ecg(1001:2000,7))))<1.7 || (max(abs(ecg(2001:3000,7)))-min(abs(ecg(2001:3000,7))))<1.7 || (max(abs(ecg(3001:4000,7)))-min(abs(ecg(3001:4000,7))))<1.7 || (max(abs(ecg(4001:end,7)))-min(abs(ecg(4001:end,7))))<1.7 ||...
       (max(abs(ecg(1:1000,8)))-min(abs(ecg(1:1000,8))))<75 || (max(abs(ecg(1001:2000,8)))-min(abs(ecg(1001:2000,8))))<75 || (max(abs(ecg(2001:3000,8)))-min(abs(ecg(2001:3000,8))))<75 || (max(abs(ecg(3001:4000,8)))-min(abs(ecg(3001:4000,8))))<75 || (max(abs(ecg(4001:end,8)))-min(abs(ecg(4001:end,8))))<75 ||...
       (max(abs(ecg(1:1000,9)))-min(abs(ecg(1:1000,9))))<50 || (max(abs(ecg(1001:2000,9)))-min(abs(ecg(1001:2000,9))))<50 || (max(abs(ecg(2001:3000,9)))-min(abs(ecg(2001:3000,9))))<50 || (max(abs(ecg(3001:4000,9)))-min(abs(ecg(3001:4000,9))))<50 || (max(abs(ecg(4001:end,9)))-min(abs(ecg(4001:end,9))))<50 ||...
       (max(abs(ecg(1:1000,10)))-min(abs(ecg(1:1000,10))))<65 || (max(abs(ecg(1001:2000,10)))-min(abs(ecg(1001:2000,10))))<65 || (max(abs(ecg(2001:3000,10)))-min(abs(ecg(2001:3000,10))))<65 || (max(abs(ecg(3001:4000,10)))-min(abs(ecg(3001:4000,10))))<65 || (max(abs(ecg(4001:end,10)))-min(abs(ecg(4001:end,10))))<65 ||...
       (max(abs(ecg(1:1000,11)))-min(abs(ecg(1:1000,11))))<90 || (max(abs(ecg(1001:2000,11)))-min(abs(ecg(1001:2000,11))))<90 || (max(abs(ecg(2001:3000,11)))-min(abs(ecg(2001:3000,11))))<90 || (max(abs(ecg(3001:4000,11)))-min(abs(ecg(3001:4000,11))))<90 || (max(abs(ecg(4001:end,11)))-min(abs(ecg(4001:end,11))))<90 ||...
       (max(abs(ecg(1:1000,12)))-min(abs(ecg(1:1000,12))))<90 || (max(abs(ecg(1001:2000,12)))-min(abs(ecg(1001:2000,12))))<90 || (max(abs(ecg(2001:3000,12)))-min(abs(ecg(2001:3000,12))))<90 || (max(abs(ecg(3001:4000,12)))-min(abs(ecg(3001:4000,12))))<90 || (max(abs(ecg(4001:end,12)))-min(abs(ecg(4001:end,12))))<90 ||...
       (meanfreq(ecg(:,1),fs))>38 || (meanfreq(ecg(:,2),fs))>38 || (meanfreq(ecg(:,7),fs))>38 || (meanfreq(ecg(:,8),fs))>38 || (meanfreq(ecg(:,9),fs))>38 || (meanfreq(ecg(:,10),fs))>38 || (meanfreq(ecg(:,11),fs))>38 || (meanfreq(ecg(:,12),fs))>38 ||...  %C5(mean freq, 2*STD but then mean of all Thresholds in 8 leads)
       (max((ecg(:,1)))-min((ecg(:,1))))>4617 || (max((ecg(:,2)))-min((ecg(:,2))))>5132 || (max((ecg(:,7)))-min((ecg(:,7))))>6172 || (max((ecg(:,8)))-min((ecg(:,8))))>8436 || (max((ecg(:,9)))-min((ecg(:,9))))>8612 || (max((ecg(:,10)))-min((ecg(:,10))))>8509 || (max((ecg(:,11)))-min((ecg(:,11))))>8216 || (max((ecg(:,12)))-min((ecg(:,12))))>6824 %C1, apha=0.05, multiply 2*STD in Grubbs formula, HV based amp Diff from orignal ECG
              
                    regname=FileList(iFile).name(1:end-4);
                    regnameC1{iFile}=regname;
                    ...
                    SaveFigfigure=(['H:\Postdoc data\My_papers\Paper1_UKB issues\upload to Git\test\figureC1\']); %folder to save figures for HV, LV and MF based outliers
               ...
               if   abs(rho(1))<0.44 || abs(rho(2))<0.71 || abs(rho(3))<0.33 || abs(rho(4))<0.27 || abs(rho(5))<0.14 || abs(rho(6))<0.04 || abs(rho(7))<0.04 || abs(rho(8))<0.08 % CC-based UKB thresholds (shown in Table VII of manuscript) 
                    regname=FileList(iFile).name(1:end-4);
                    regnameC2{iFile}=regname;
                    hFig=figure;
                    ...
                    SaveFigfigure=(['H:\Postdoc data\My_papers\Paper1_UKB issues\upload to Git\test\figureC2\']); %folder to save lead reversal based 12 lead ECGs
                    fullFileName = fullfile(SaveFigfigure,regname);
                    saveas(hFig,fullFileName,'png');
                    close(hFig)
              else
